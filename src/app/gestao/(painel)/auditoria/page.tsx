...
function humanAction(action: string) { const map: Record<string, string> = { "manager.created": "Gestora cadastrada", "manager.updated": "Cadastro de gestora atualizado", "period.created": "Período criado", "period.open": "Período aberto", "period.closed": "Período fechado", "period.adjusted": "Prazo do período ajustado", "response.reopened": "Resposta reaberta", "response.soft_deleted": "Resposta excluída logicamente", "response.note_updated": "Observação atualizada", "indicator.updated": "Indicador alterado", "scoring.updated": "Parâmetros de pontuação atualizados" }; return map[action] ?? action; }
